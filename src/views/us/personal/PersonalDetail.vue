    ...
    <template v-if="activeName === 'acc'">
      <div class="user-account">
        <div class="info-wrap">
          ...
          <el-form :model="form" label-width="150px" style="width:450px; margin-left: -100px">
            <el-form-item :label="$t('personal.account.label_first_name')">
              <el-input
            ...
            <el-form-item :label="$t('personal.account.label_last_name')">
              <el-input
                v-model="form.company"
                :placeholder="
                  $t('personal.account.placeholder_label_company_name')
            ...
            <el-form-item :label="$t('personal.account.label_country')">
              <el-input
                v-model="form.company"
                :placeholder="
                  $t('personal.account.placeholder_label_company_name')
            ...
            <el-form-item
              :label="$t('personal.account.label_industry')"
              class="phone-select-fix"
            >
                <el-select v-model="form.org" placeholder="choice">
                  <el-option
      ...
      <div class="user-order">
        <div class="info-wrap">
          <h3 class="acc-title">
            {{ $t('personal.account.label_login') }}
          </h3>
          <h4 class="acc-sub">
          ...
          <table class="login-status" rules="none">
            ...
            <thead>
              <th>{{ $t('personal.account.label_id') }}</th>
              <th>{{ $t('personal.account.label_device_information') }}</th>
              <th>{{ $t('personal.account.label_ip') }}</th>
              <th>{{ $t('personal.account.label_login_time') }}</th>
              <th>{{ $t('personal.account.lable_current_device_or_not') }}</th>
              <th>{{ $t('personal.account.lable_unbinding') }}</th>
            </thead>
            <tbody>
              <tr>
      ...
      <div class="user-order">
        <div class="info-wrap">
          ...
          <table class="login-status" rules="none">
            ...
            <thead>
              <th>{{ $t('personal.account.lable_member_function') }}</th>
              <th>{{ $t('personal.account.label_times_per_mounth') }}</th>
            </thead>
            <tbody>
              <tr>
                <td>{{ $t('personal.account.label_user') }}</td>
                <td>{{ userPackage.deviceLimit || 0 }}</td>

              </tr>
              <tr>
                <td>{{ $t('personal.account.lable_Dashboard_access') }}</td>
                <td>{{ userPackage.deviceLimit || 0 }}</td>

              </tr>
              <tr>
                <td>{{ $t('personal.account.label_Ads_View') }}</td>
                <td>
                  {{ userPackage.ttSearchUsed || 0 }} /
                  {{ userPackage.ttSearchLimit || 0 }}
                </td>
              ...
              <tr>
                <td>{{ $t('personal.account.label_Posts_details') }}</td>
                <td>
                  {{ userPackage.adDetailUsed || 0 }} /
                  {{ userPackage.adDetailLimit || 0 }}
                </td>
              ...
              <tr>
                <td>{{ $t('personal.account.label_Advertisers') }}</td>
                <td>
                  {{ userPackage.adverSearchUsed || 0 }} /
                  {{ userPackage.adverSearchLimit || 0 }}
                </td>
              ...
              <tr>
                <td>{{ $t('personal.account.label_Advertisers_details') }}</td>
                <td>
                  {{ userPackage.adverDetailUsed || 0 }} /
                  {{ userPackage.adverDetailLimit || 0 }}
                </td>
              ...
              <tr>
                <td>{{ $t('personal.account.label_Downloadable_data') }}</td>
                <td>
                  {{ userPackage.adverDetailUsed || 0 }} /
                  {{ userPackage.adverDetailLimit || 0 }}
                </td>
...
import { PAYMENT_TYPE, INDUSTRY } from '@/constants/config'
